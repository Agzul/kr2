...
class DescriptionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create description" do
    assert_difference('Description.count') do
      post descriptions_url, params: { description: { description: @description.description, film_id: @description.film_id, keywords: @description.keywords } }
    end
  ...
  test "should update description" do
    patch description_url(@description), params: { description: { description: @description.description, film_id: @description.film_id, keywords: @description.keywords } }
